...
Partial Class Petugas
    ...
    Private Sub InitializeComponent()
        ...
        DGView1.Columns.AddRange(New DataGridViewColumn() {Column1, Column3, Column2, Column6, Column7, Column10, Column4, btnEdit, btnHapus})
        ...
        Label1.TabIndex = 6
        Label1.Text = "MANAJEMEN DATA PETUGAS"
